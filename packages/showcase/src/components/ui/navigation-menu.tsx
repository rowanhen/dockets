...
const navigationMenuTriggerStyle = cn(
	'group inline-flex h-9 items-center justify-center gap-1 rounded-[var(--radius)] px-3 py-2 text-xs font-medium uppercase tracking-wider hover:bg-[var(--hover-bg)] focus-ring disabled:pointer-events-none disabled:opacity-50',
)
...
function NavigationMenuLink({ className, ...props }: React.ComponentProps<'a'>) {
	return (
		<a
			...
			className={cn(
				'block select-none rounded-[var(--radius)] px-3 py-2 text-xs leading-none hover:bg-[var(--hover-bg)] focus-ring',
				className,
			)}
			{...props}
		/>
