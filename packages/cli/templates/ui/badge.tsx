...
const badgeVariants = cva(
	'group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-none border border-transparent px-2 py-0.5 text-xs font-medium uppercase tracking-wider whitespace-nowrap has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 [&>svg]:pointer-events-none [&>svg]:size-3!',
	{
		variants: {
			variant: {
